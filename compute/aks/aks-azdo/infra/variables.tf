...
variable "network" {
  ...
  default = {
    ...
    aks_subnet_address_space          = ["172.16.240.0/24"]
  }
}
...
variable "user_node_pool_name" {
  type        = string
  description = "Name of the user node pool in AKS cluster"
  default     = "azdo"
}
...
variable "user_node_pool_vm_size" {
  type        = string
  description = "VM size for the user node pool in AKS cluster"
  default     = "Standard_B2als_v2"
}
